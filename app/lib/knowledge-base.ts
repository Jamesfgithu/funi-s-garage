...
export const emailTemplates = [
  {
    ...
    description:
      'Addresses core frustration of safelist users - wasted time and zero results',
...
Generate clean, professional email. NO analysis or explanations. Ready-to-send format.`,
  },
  {
    ...
    description:
      'Perfect for building lists with skeptical safelist users - under 5 lines',
...
Generate clean, professional email. NO analysis or explanations. Ready-to-send format.`,
  },
  {
    ...
    description:
      "Leverages 'Find an Offer, Mail an Offer' principle - can be written in minutes",
...
Generate clean, professional email. NO analysis or explanations. Ready-to-send format.`,
  },
  {
    ...
    description:
      "Breaks the 'credit-clicking trance' by addressing immediate context",
    ...
    conversionFactor:
      'Very High - breaks through email overwhelm with direct relevance',
...
Generate clean, professional email. NO analysis or explanations. Ready-to-send format.`,
  },
  {
    ...
    description:
      'Transfers credibility to affiliate offer through authentic storytelling',
    category: 'affiliate-offers',
...
Generate clean, professional email. NO analysis or explanations. Ready-to-send format.`,
  },
  {
    ...
    description:
      'Acknowledges limitations upfront, increasing believability with skeptical audiences',
    ...
    conversionFactor:
      'High - transparency increases believability in skeptical market',
...
Generate clean, professional email. NO analysis or explanations. Ready-to-send format.`,
  },
  {
    ...
    description:
      'Comprehensive framework covering all persuasion elements for mid to high-priced products',
    category: 'paid-offers',
    ...
    conversionFactor:
      'Very High - addresses all major objections systematically',
...
Generate clean, professional email. NO analysis or explanations. Ready-to-send format.`,
  },
  {
    ...
    description:
      'Essential for final deadline emails - P.S. is most-read part of emails',
    category: 'follow-up',
    ...
    conversionFactor:
      'Extremely High - captures procrastinators at decision point',
...
Generate clean, professional email. NO analysis or explanations. Ready-to-send format.`,
  },
  {
    ...
    description:
      'Creates reciprocity without strings attached, building long-term trust',
    ...
    conversionFactor:
      'High - builds long-term relationship and positions for future sales',
...
Generate clean, professional email. NO analysis or explanations. Ready-to-send format.`,
  },
  {
    ...
    description:
      "Recovers lost prospects based on Ogilvy's principle - captures people whose circumstances changed",
    category: 'follow-up',
...
export const comprehensiveCopywritingPrinciples = [
  {
    ...
    explanation:
      'In safelist marketing, the sole purpose is generating clicks. Every word must drive toward the click.',
    application:
      'Subject lines must break patterns, body copy must create curiosity gaps, CTAs must be irresistible.',
  },
  {
    principle: 'BAB Framework Mastery',
    explanation:
      'Before-After-Bridge under 5 lines for safelists. Most powerful for lead magnets.',
    application:
      'Paint current pain, show desired outcome, bridge with your solution. Keep ultra-concise.',
  },
  {
    principle: '4Ps Complete Persuasion',
    explanation:
      'Picture-Promise-Proof-Push covers all persuasion elements for paid offers.',
    application:
      'Success visualization, specific claims, credibility elements, urgency with guarantees.',
  },
  {
    principle: 'Polarization Principle',
    explanation:
      'No money in the middle. Force strong reactions - love it or hate it.',
    application:
      'Make bold claims, take controversial positions, eliminate wishy-washy language.',
  },
  {
    principle: 'Damaging Admission Strategy',
    explanation:
      'Address flaws to increase believability with skeptical audiences.',
    application:
      'Admit limitations upfront, qualify prospects, increase overall credibility.',
  },
  {
    principle: 'Direct Context Callout',
    explanation:
      'Address current activity (clicking for credits) to break email trance.',
    application:
      'Reference their current situation, acknowledge their frustration, provide immediate relevance.',
  },
  {
    principle: 'Pattern Interrupt Mastery',
    explanation: 'Break expected safelist email patterns to capture attention.',
    application:
      'Unexpected openings, unusual formatting, contrarian viewpoints, surprising admissions.',
  },
  {
    principle: 'Loss Aversion Leverage',
    explanation:
      'Frame inaction as loss rather than action as gain. More powerful motivator.',
    application:
      "Emphasize what they're losing by not acting, quantify missed opportunities.",
  },
  {
    principle: 'Social Proof Velocity',
    explanation: 'Use real-time indicators for momentum and urgency.',
    application:
      'Recent testimonials, current user counts, time-sensitive social indicators.',
  },
  {
    principle: 'Reciprocity Building',
    explanation: 'Give value first to create psychological obligation.',
    application:
      'Free gifts, valuable insights, helpful resources before asking for anything.',
  },
];
...
export const safelistPsychologyTriggers = [
  {
    ...
    implementation:
      "Start with 'I know you're skeptical...' or 'This sounds too good to be true, but...'",
  },
  {
    trigger: 'Email Pattern Interrupt',
    description: 'Break expected email patterns to capture attention',
    implementation:
      'Unusual subject lines, unexpected openings, contrarian statements',
  },
  {
    trigger: 'Diderot Effect',
    description:
      'Buyers keep buying related solutions - leverage this tendency',
    implementation:
      'Reference other tools they likely own, build on existing purchases',
  },
  {
    trigger: 'Loss Aversion for Safelists',
    description: "Emphasize what they're losing by not acting",
    implementation:
      'Quantify wasted credits, missed opportunities, competitor advantages',
  },
  {
    trigger: 'Social Proof Velocity',
    description: 'Real-time social indicators create momentum',
    implementation:
      'Recent signups, current user activity, time-sensitive testimonials',
  },
  {
  ...
  },
  {
    ...
    implementation:
      'Reference their current activity, acknowledge their situation',
  },
];
...
export const advancedSafelistStrategies = [
  {
    ...
    insight:
      'Safelist users are in a trance-like state clicking for credits. Pattern interrupts are essential.',
    tactics: [
      'Direct callouts',
  ...
  },
  {
    ...
    insight:
      "They're fellow marketers, not consumers. Speak their language and acknowledge their expertise.",
    tactics: [
      'Industry terminology',
      'Marketing challenges',
      'Business-to-business tone',
      'Peer-level respect',
    ],
  },
  {
    ...
    insight:
      'Extremely high skepticism due to constant exposure to hype and false promises.',
    tactics: [
      'Damaging admissions',
      'Honest limitations',
      'Proof elements',
  ...
  },
  {
    ...
    insight:
      "They're scanning quickly while clicking for credits. Brevity and clarity are crucial.",
    tactics: [
  ...
  },
  {
    ...
    insight:
      'Primary pain point is getting traffic and conversions. Everything else is secondary.',
    tactics: [
      'Traffic promises',
...
// Export your templates so other files can use them
export const SAFELIST_TEMPLATES = {
  pas_pain_point: {
    name: 'P.A.S. Pain Point',
    conversion: 'Extremely High',
    opening:
      'Fellow entrepreneur, I just discovered something that could solve your biggest problem...',
    cta: "Don't let another day pass struggling with this issue.",
    ps: 'This breakthrough could change everything for you.',
  },
  bab_lead_magnet: {
    name: 'B.A.B. Lead Magnet',
    conversion: 'High',
    opening: 'Before I share this with you, let me ask you something...',
    cta: 'Get instant access to this game-changing resource.',
    ps: "Remember, this free resource won't be available forever.",
  },
  quick_find_mail: {
    name: 'Quick Find & Mail',
    conversion: 'High',
    opening:
      'I just found something incredible and had to share it immediately...',
    cta: "Check this out before it's gone.",
    ps: 'I wish I had found this years ago.',
  },
  direct_callout: {
    name: 'Direct Callout',
    conversion: 'High',
    opening: "Fellow marketer, this is exactly what you've been looking for...",
    cta: 'Take action now while this is still available.',
    ps: "Don't let this opportunity slip away.",
  },
  personal_story: {
    name: 'Personal Story Bridge',
    conversion: 'Very High',
    opening: 'Let me tell you about the day everything changed for me...',
    cta: 'Your breakthrough moment could be just one click away.',
    ps: 'This could be your turning point too.',
  },
  damaging_admission: {
    name: 'Damaging Admission',
    conversion: 'High',
    opening: 'I have to admit something embarrassing...',
    cta: 'Learn from my mistakes and get ahead faster.',
    ps: "Don't make the same costly errors I did.",
  },
  four_ps_product: {
    name: '4Ps Product Promotion',
    conversion: 'Very High',
    opening: 'This proven system delivers exactly what you need...',
    cta: 'Get started with this breakthrough system today.',
    ps: 'Success leaves clues - follow them.',
  },
  urgent_ps_reminder: {
    name: 'Urgent P.S. Reminder',
    conversion: 'Extremely High',
    opening: 'Time is running out on this incredible opportunity...',
    cta: 'Secure your spot before the deadline.',
    ps: 'URGENT: Only hours left to take advantage of this.',
  },
  moving_parade: {
    name: 'Moving Parade Re-engagement',
    conversion: 'High',
    opening: 'While you were thinking it over, others took action...',
    cta: "Don't get left behind - join the success parade.",
    ps: 'The parade is moving - are you on it or watching it pass by?',
  },
};
